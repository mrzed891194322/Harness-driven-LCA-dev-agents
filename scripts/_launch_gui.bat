...
REM Double-click this file to run scripts\debug_gui\launch_gui.ps1 via PowerShell.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\debug_gui\launch_gui.ps1"
