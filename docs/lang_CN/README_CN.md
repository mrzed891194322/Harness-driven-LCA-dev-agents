...
4. 检查未通过时：uv 细节见 [环境准备与配置](env_setup.md)，RAG 模型见 [RAG 指南](rag_guide.md)，openLCA IPC 见 [项目准备说明](project_prep.md)。
...
| [RAG 构建与查询](rag_guide.md) | 在 GUI 或 `.env` 配置 Embedding、构建知识库 |
