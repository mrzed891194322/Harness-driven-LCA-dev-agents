...
详细的 JSON-LD 写入约定见 `harness/specs/03-dataset-mapping/`。
...
```bash
uv run python harness/tools/mcp/control_openlca/import_from_json/main.py <JSON配置文件目录> --host <主机地址> --port <端口>
```
