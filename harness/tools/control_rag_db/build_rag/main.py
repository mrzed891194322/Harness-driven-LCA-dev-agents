...
def main():
    ...
    parser.add_argument(
        "--input-dir", "-i",
        type=str,
        default="harness/knowledge/inputs",
        help="Input directory containing PDF/Word/Markdown/Text files (default: harness/knowledge/inputs)"
    )
    parser.add_argument(
        "--output-dir", "-o",
        type=str,
        default="harness/knowledge/rag_db",
        help="Output directory for Chroma RAG database (default: harness/knowledge/rag_db)"
    )
