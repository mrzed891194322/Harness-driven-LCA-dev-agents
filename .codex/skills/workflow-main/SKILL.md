---
name: workflow-main
description: 通过分阶段的计划接收、证据检索、最多三次 LCI 审查循环、openLCA 写入预检、自动导入回读、LCIA 计算及结果归档，来无人值守地执行已有的 LCA 执行计划（execution_plan.md）。适用于本仓库中的 whole-lca 或端到端 plan-to-LCIA 运行。
---
