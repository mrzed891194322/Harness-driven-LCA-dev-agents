...
REM Double-click this file to run src\scripts\debug_gui\launch_gui.ps1 via PowerShell.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0src\scripts\debug_gui\launch_gui.ps1"
