...
- 使用 `harness/specs/plan-guidelines/references/templates/execution_plan.md` 形成 `workspace/plan/execution_plan.md`。
- 将所有无法确定的信息、缺口数据和决策项汇总到 `workspace/plan/todo_list.md`。
- `todo_list.md` 必须使用 `harness/specs/plan-guidelines/references/templates/todo_list.md`。
