...
```bash
uv run python .opencode/skills/control-openlca/assets/query_descriptors/main.py <Type> [--search <keyword>] [--limit <number>]
```
...
```bash
uv run python .opencode/skills/control-openlca/assets/query_descriptors/main.py Process --search electricity
```
