...
2. **Python 脚本编写与运行规范**
   - **instructions/python_specification.md**：包含 Python 运行环境 (uv)、编写与运行范围限制 (GUI/、harness/tools/、scripts/ 与 workspace/)、临时脚本存放约定 (workspace/tmp/)、文件操作的安全边界，以及 python项目编写模板。
